		...
		<div id="page">
			...
			<div class="bannerPane banner-bg">
				...
				<div class="s-banner-content">
					<i class="fa fa-user"></i> Login ke Akun Anda
				</div>
			</div>
			<!-- MAP -->
			...
			<div id="content">
				...
				<form class="contactForm" action="<?php echo base_url().'member/auth'?>" method="post">
					
					<input type="text" name="nama" placeholder="Email" required>
					
					<input type="text" name="nomeja" placeholder="Password" required>
					
					<button type="submit" class="o-buttons red" style="border:none;height:38px;width:70px;">Login</button>
				</form>
					<p>Jika Anda belum memiliki akun. Daftarkan akun anda disini. <a href="<?php echo base_url().'member/register'?>">Mendaftar</a></p>
