...
<html >
	<head>
		...
		<meta name="author" content="M-food">
						...
						<div data-thumb="<?php echo base_url().'assets/gambar/'.$gambar;?>" data-src="<?php echo base_url().'assets/gambar/'.$gambar;?>">
							<div class="bannerContent fadeFromBottom">
								<div class="b-c-textpane">
									...
									<p><a href="<?php echo base_url().'menu/detail_menu/'.$id;?>" style="color:#fff;text-decoration:none;">Pesan Sekarang</a></p>
									<a href="<?php echo base_url().'menu'?>" class="home-scl-icon gplus">
